...
var rabbit,background,mute,Ground,Rope,egg1,button;
...
function setup(){
  ...
  rabbit = Bodies.rectangle(egg1.position.x,height-120,150,150);
...
function Coliision(body1,body2){//função pra dectar colisão
  if(body1 != null){
  var d = dist(body1.position.x,body1.position.y,body2.position.x,body2.position.y);//body1 e body2 são genericos
  if(d<=50){
